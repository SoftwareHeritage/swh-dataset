...
class BaseWriter:
    ...
    def current_row(self) -> int:
        """Returns how many rows are in the file + in the buffer"""
        raise NotImplementedError(f"{self.__class__.__name__}.current_row()")
...
class BaseTabularExporter(ExporterDispatch, Generic[Writer]):
    """
    ...
    def new_person_writer(self, unique_id: uuid.UUID) -> Writer:
        raise NotImplementedError(f"{self.__class__.__name__}.new_person_writer()")
